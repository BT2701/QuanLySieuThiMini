...
public class ThucPhamChuaCheBien extends ThucPham{
	public ThucPhamChuaCheBien() {
		super();
		// TODO Auto-generated constructor stub
	}

	public ThucPhamChuaCheBien(String tenSP, String maSP, String nhaCC, double tienGoc, double tenBanRa, int sl_nhap,
	...
	public void layThongTinMotSanPham() {
		...
		try {
			...
			FileReader fr = new FileReader("thucPhamChuaCheBien.TXT");
	...
	public void xuatHoaDon1SP() {
		...
		System.out.printf("\t\t thực phẩm chưa chế biến\n");
