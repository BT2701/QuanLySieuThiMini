...
public class NHANVIENTHUNGAN extends NHANVIEN{
    ...
    public NHANVIENTHUNGAN(String tenNV, String maNV, String gioiTinh, String diDong, String ngaySinh,
            String thoiGianLamViec, String nguoiQuanLy ,String chucVu,int ngayCong) {
