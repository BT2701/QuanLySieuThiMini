...
public class RauCuQua extends ThucPham{
	...
	public RauCuQua(String tenSP, String maSP, String nhaCC, double tienGoc, double tenBanRa, int sl_nhap, int sl_ton,
			NGAYTHANGNAM hsd) {
	...
	public void layThongTinMotSanPham() {
		...
		try {
			...
			FileReader fr = new FileReader("rauCuQua.TXT");
